                ...
                <div class="form-group"><!-- form-group Begin -->
                  ...
                  <label class="col-md-3 control-label"> Product Image 1 </label> 
                    ...
                    <div class="col-md-6"><!-- col-md-6 Begin -->
                      ...
                      <img width="200" height="200" src="product_images/<?php echo $p_image1 ?>" alt="<?php echo $p_image1 ?>">
                ...
                <div class="form-group"><!-- form-group Begin -->
                  ...
                  <label class="col-md-3 control-label"> Product Image 2 </label> 
                    ...
                    <div class="col-md-6"><!-- col-md-6 Begin -->
                      ...
                      <img width="200" height="200" src="product_images/<?php echo $p_image2 ?>" alt="<?php echo $p_image2 ?>">
                ...
                <div class="form-group"><!-- form-group Begin -->
                  ...
                  <label class="col-md-3 control-label"> Product Image 3 </label> 
                    ...
                    <div class="col-md-6"><!-- col-md-6 Begin -->
                      ...
                      <img width="200" height="200" src="product_images/<?php echo $p_image3 ?>" alt="<?php echo $p_image3 ?>">
...
<?php 
    ...
    if(isset($_POST['update'])){
      ...
      if($run_product){
        ...
        echo "<script>alert('The product details has been updated successfully')</script>";
